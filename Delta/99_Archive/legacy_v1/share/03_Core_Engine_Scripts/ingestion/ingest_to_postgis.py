...
def _load_dotenv_if_present() -> None:
    ...
    env_file = project_root / "04_Test" / ".env"
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input-dir",
        default=str(pathlib.Path(__file__).parent.parent.parent / "04_Test" / "result_output"),
        help="Directory containing exported CSV files. "
             "Default: <project_root>/04_Test/result_output/",
    )
    parser.add_argument(
        "--dry-run",
        action="store_true",
