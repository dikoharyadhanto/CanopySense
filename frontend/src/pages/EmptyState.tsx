  ...
  return (
    <div className="min-h-screen bg-[#F4FAF6] flex items-center justify-center px-4">
      <div className="bg-white rounded-xl shadow-md p-10 w-full max-w-md text-center">
        ...
        <h1 className="text-lg font-bold text-slate-800 mb-2">Belum Terhubung ke Perusahaan</h1>
        <p className="text-sm text-slate-500 leading-relaxed mb-8">
          Anda belum terhubung ke perusahaan manapun. Tunggu undangan dari Manager perusahaan Anda.
          Tautan undangan akan dikirimkan ke email Anda.
        </p>
        <button
