    ...
    <div className="flex-1 overflow-y-auto p-6">
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        ...
        <div className="bg-white rounded-lg border border-slate-200 p-4">
          ...
          <div className="text-sm text-slate-500 mt-1">Active Managers</div>
        </div>
        <div className="bg-white rounded-lg border border-slate-200 p-4">
          <div className="text-sm font-semibold text-slate-600 mb-2">Subscriptions</div>
      ...
      <div className="bg-white rounded-lg border border-slate-200">
        <div className="px-4 py-3 border-b border-slate-100">
          <h2 className="text-sm font-semibold text-slate-700">Recent Admin Actions</h2>
        </div>
        {data.recent_audit_actions.length === 0 ? (
          <div className="p-4 text-sm text-slate-400">No recent actions</div>
        ) : (
